...
namespace CRUD_Basico.datosDataSetTableAdapters {
    ...
    public partial class clientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `clientes` WHERE ((`Id` = ?) AND ((? = 1 AND `nombre` IS NULL) OR (`n" +
                "ombre` = ?)) AND ((? = 1 AND `apellidos` IS NULL) OR (`apellidos` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `clientes` (`nombre`, `apellidos`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `clientes` SET `nombre` = ?, `apellidos` = ? WHERE ((`Id` = ?) AND ((? = 1" +
                " AND `nombre` IS NULL) OR (`nombre` = ?)) AND ((? = 1 AND `apellidos` IS NULL) O" +
                "R (`apellidos` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD_Basico.Properties.Settings.Default.datosConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, nombre, apellidos FROM clientes";
        ...
        public virtual int Fill(datosDataSet.clientesDataTable dataTable) {
        ...
        public virtual datosDataSet.clientesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            datosDataSet.clientesDataTable dataTable = new datosDataSet.clientesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(datosDataSet.clientesDataTable dataTable) {
